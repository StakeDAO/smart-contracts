...
const VAULT = '0xB17640796e4c27a39AF51887aff3F8DC0daF9567';
const WANT = '0x6c3F90f043a72FA612cbac8115EE7e52BDe6E490';
const GOVERNANCE = '0xF930EBBd05eF8b25B1797b9b2109DDC9B0d43063';
const WANT_HOLDER = '0x89515406c15a277f8906090553366219b3639834';
...
describe('Convex3CRV', function () {
  ...
  before(async function () {
    ...
    const Strategy = await ethers.getContractFactory('Strategy3CrvConvex');
  ...
  it('All funds should be in vault', async function () {
    ...
    const vault3crBalance = await want.balanceOf(vault.address);
    expect(vaultBalance.eq(vault3crBalance)).to.be.true;
  });

  it('should deposit 95% of vault balance in convex 3pool', async function () {
    this.enableTimeouts(false);
    const vaultBalance = await vault.balance();
