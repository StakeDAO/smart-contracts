...
const WANT = '0xFD5dB7463a3aB53fD211b4af195c5BCCC1A03890'; // eurtCRV
const GOVERNANCE = '0xF930EBBd05eF8b25B1797b9b2109DDC9B0d43063';
const WANT_HOLDER = '0x93c937a619657e25b2df27586fc91356278759f3'; // bug eurtCRV holder
...
describe('ConvexEur', function () {
  ...
  before(async function () {
    ...
    const Strategy = await ethers.getContractFactory('StrategyEurtConvex');
