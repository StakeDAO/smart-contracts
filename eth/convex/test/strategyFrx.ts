...
const VAULT = '0x99780beAdd209cc3c7282536883Ef58f4ff4E52F';
const WANT = '0xd632f22692FaC7611d2AA1C0D552930D43CAEd3B'; // frax LP
const GOVERNANCE = '0xF930EBBd05eF8b25B1797b9b2109DDC9B0d43063';
const WANT_HOLDER = '0x07A75Ba044cDAaa624aAbAD27CB95C42510AF4B5'; // bug eursCRV holder
...
describe('ConvexFrx', function () {
  ...
  before(async function () {
    ...
    const Strategy = await ethers.getContractFactory('StrategyFrxConvex');
  ...
  it('should deposit 95% of vault balance in convex frax', async function () {
    this.enableTimeouts(false);
    const vaultBalance = await vault.balance();
  ...
  it('should lock all CRV and ensure we have more LP in baseRewardPool', async function () {
    this.enableTimeouts(false);
