...
const WANT_HOLDER = '0x56c915758Ad3f76Fd287FFF7563ee313142Fb663';
...
describe('ConvexSeth', function () {
  ...
  before(async function () {
    ...
    const Strategy = await ethers.getContractFactory('StrategyStEthConvex');

    random = await ethers.provider.getSigner(RANDOM);
